...
- haversine _Calculates distance between two GPS coordinates using Haversine formula which accounts for the curvature of the Earth which affects longitude._
